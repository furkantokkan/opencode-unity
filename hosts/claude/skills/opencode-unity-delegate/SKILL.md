...
allowed-tools: Bash(opencode-unity delegate health:*), Bash(opencode-unity delegate ask:*), Bash(opencode-unity delegate map:*), Bash(opencode-unity delegate ledger:*), Bash(opencode-unity guard:*), Bash(opencode-unity status:*), Bash(opencode-unity doctor:*)
---

# opencode-unity delegate (preview)

This is a preview host file for opencode-unity 0.1.0-preview.1. It tells you, the host agent, when and
